...
public class ScreenshakeManager : MonoBehaviour
{
    ...
    public static void Shake(EShakeType _type)
    {
        switch (_type)
        {
            case EShakeType.small:
                s_instance.m_smallShake.GenerateImpulse();
                break;
            case EShakeType.medium:
                s_instance.m_mediumShake.GenerateImpulse();
                break;
            case EShakeType.shortSharp:
                s_instance.m_shortSharpShake.GenerateImpulse();
                break;
        }
    }
}
